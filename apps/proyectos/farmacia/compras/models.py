...
from apps.proyectos.farmacia.medicamentos.models import Medicamentos
from apps.proyectos.farmacia.distribuidor.models import Distribuidor
from apps.proyectos.farmacia.laboratorio.models import Laboratorio
